...
<form action="Starters">
	Enter item 1: <input type="text" name="str_item1"><br><br>
	Enter item 2: <input type="text" name="str_item2"><br><br>
	Enter item 3: <input type="text" name="str_item3"><br><br>
	Enter item 4: <input type="text" name="str_item4"><br><br>
	Enter item 5: <input type="text" name="str_item5"><br><br>
