...
String bev_item1=(String)session.getAttribute("bev_item1");
String bev_item2=(String)session.getAttribute("bev_item2");
String bev_item3=(String)session.getAttribute("bev_item3");
String bev_item4=(String)session.getAttribute("bev_item4");
String bev_item5=(String)session.getAttribute("bev_item5");

String snk_item1=(String)session.getAttribute("snk_item1");
String snk_item2=(String)session.getAttribute("snk_item2");
String snk_item3=(String)session.getAttribute("snk_item3");
String snk_item4=(String)session.getAttribute("snk_item4");
String snk_item5=(String)session.getAttribute("snk_item5");

String str_item1=(String)session.getAttribute("str_item1");
String str_item2=(String)session.getAttribute("str_item2");
String str_item3=(String)session.getAttribute("str_item3");
String str_item4=(String)session.getAttribute("str_item4");
String str_item5=(String)session.getAttribute("str_item5");

String mm_item1=(String)session.getAttribute("mm_item1");
String mm_item2=(String)session.getAttribute("mm_item2");
String mm_item3=(String)session.getAttribute("mm_item3");
String mm_item4=(String)session.getAttribute("mm_item4");
String mm_item5=(String)session.getAttribute("mm_item5");

String rice_item1=(String)session.getAttribute("rice_item1");
String rice_item2=(String)session.getAttribute("rice_item2");
String rice_item3=(String)session.getAttribute("rice_item3");
String rice_item4=(String)session.getAttribute("rice_item4");
String rice_item5=(String)session.getAttribute("rice_item5");

String des_item1=(String)session.getAttribute("des_item1");
String des_item2=(String)session.getAttribute("des_item2");
String des_item3=(String)session.getAttribute("des_item3");
String des_item4=(String)session.getAttribute("des_item4");
String des_item5=(String)session.getAttribute("des_item5");
